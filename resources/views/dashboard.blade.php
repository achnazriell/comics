<x-app-layout>
    <div class="container mx-auto p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-gray-300 shadow-md rounded-lg overflow-hidden transform transition-transform duration-300 hover:-translate-y-2 flex flex-col border border-gray-400">
                @if($comic->image)
